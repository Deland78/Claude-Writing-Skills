...
### Inputs
- **Required**: `story_concept`, `genre`, `opening_situation`
- **Optional**: `protagonist_name`, `inciting_incident`, `target_length`

### Steps
1. Identify what kind of story this is (genre, tone, emotional experience promised).
2. Define the central question or conflict that will drive the narrative.
3. Specify the stakes that must be resolved by story's end.
4. Verify the promise can be established in the first 10-15% of the story.
5. Produce a one-paragraph story promise statement.
...
- Examples: Thriller with ticking bomb → promises tension and race against time; Mystery with murdered body → promises killer will be revealed.
